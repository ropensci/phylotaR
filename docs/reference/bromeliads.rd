...
<title>Example phylota object (bromeliads) — bromeliads • phylotaR</title>
...
<meta property="og:title" content="Example phylota object (bromeliads) — bromeliads" />

<meta property="og:description" content="Final phylota object produced by running pipeline for the bromeliads, Bromeliaceae (4613)." />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Example phylota object (bromeliads)</h1>
    
    <div class="hidden name"><code>bromeliads.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Final phylota object produced by running pipeline for the bromeliads, Bromeliaceae (4613).</p>
    
    </div>

    <pre class="usage"><span class='fu'>data</span>(<span class='no'>bromeliads</span>)</pre>
        
    <h2 class="hasAnchor" id="format"><a class="anchor" href="#format"></a>Format</h2>

    <p><code>bromeliads</code> is generated from read_phylota().</p>
...
#&gt;   ..@ cids   : chr [1:721] "0" "1" "2" "3" ...
#&gt;   ..@ txids  : chr [1:1172] "100681" "1349380" "1485041" "1485031" ...
#&gt;   ..@ sids   : chr [1:9840] "AF162230.2/1..1536" "AY438602.1" "HQ913671.1/54..670" "HQ882722.1/1..573" ...
